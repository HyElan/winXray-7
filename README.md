...
如果无法下载上面的文件或者速度慢，请将浏览器地址栏的域名 github.com 更新为 **github.com.cnpmjs.org** 并重新打开本页面即可。  
也可以请使用 jsdelivr 的镜像地址下载( 缓存12小时 )：[https://cdn.jsdelivr.net/gh/winXray(或当前fork用户名)/winXray/release/winXray.7z](https://cdn.jsdelivr.net/gh/winXray/winXray/release/winXray.7z)
